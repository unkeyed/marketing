...
The documentation has been updated, we shortened the [quickstart flow](https://unkey.com/docs/quickstart) and documented the [update key](https://www.unkey.com/docs/libraries/ts/api) for the Unkey SDK. Look out for our new Next.js wrapper coming soon!
