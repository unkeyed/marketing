...
const OpenSourceFriends = async () => {
  ...
  try {
    ...
    console.error("Failed to fetch OSS friends:", error);
    // Fallback to empty array - component will show graceful message
  }
  return (
            ...
            {OSSFriends.length === 0 ? (
              <div className="col-span-full text-center py-12">
                <p className="text-white/60">
                  Unable to load our friends at the moment. Please check back later!
                </p>
              </div>
            ) : (
