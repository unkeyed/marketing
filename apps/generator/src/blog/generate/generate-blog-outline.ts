...
export async function generateBlogOutlineStep({
  ...
  return withRetry(async () => {
    ...
    const audienceGuidance = {
      beginner: "Write for developers new to this topic. Explain concepts from first principles, avoid jargon without definition, and use simple analogies.",
      intermediate: "Write for developers with working knowledge. Assume familiarity with basic concepts but explain advanced patterns and nuances.",
      advanced: "Write for senior developers and architects. Focus on edge cases, performance implications, trade-offs, and advanced patterns.",
    }[audienceLevel];
...
Create a cohesive outline that weaves these terms together into a single compelling blog post.`,
    ...
    console.info(`[blog-outline] Generated ${outline.length} sections for blog post ${blogPostId}`);
    return outline;
